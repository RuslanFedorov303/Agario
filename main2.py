...
cells = [Ball(randint(-2000, 2000), randint(-2000, 2000), 10, (randint(0, 255), randint(0, 255), randint(0, 255))) for _ in range(300)]
f = font.Font(None, 50)
...
while running:
    ...
    bg_scaled_size = int(WORLD_SIZE * ball.scale) // 6
